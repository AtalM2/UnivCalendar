 ...
 *
 * <ul> <li>Retrieving the metafeed list of all the user's calendars</li>
 * <li>Retrieving the allcalendars list of calendars</li> <li>Retrieving the
 * owncalendars list of calendars</li> <li>Creating a new calendar</li>
 * <li>Updating an existing calendar</li> <li>Deleting a calendar</li>
 * <li>Subscribing to an existing calendar</li> <li>Updating a subscription</li>
 * <li>Deleting a subscription</li> </ul>
 */
